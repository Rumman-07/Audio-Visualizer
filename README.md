...
- Fullscreen mode and auto-hide UI for immersive view  
- Monitor Mic toggle (prevent echo)  
- Control panel with sensitivity, color modes and preset-specific options  
